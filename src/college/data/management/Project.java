...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/ProjectBG.png"));
        ic.getAccessibleContext();
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/AddingUser.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon2.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/DetailsUser.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/DetailsTeacher.png"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/InputAttendanceStudent.png"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/AttendanceDetails.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/AttendanceDetails.png"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/MarksDetails.png"));
        Image image31 = icon30.getImage().getScaledInstance(20, 30,Image.SCALE_DEFAULT);
        c1.setIcon(new ImageIcon(image31));
        c1.setBackground(Color.WHITE);
        exam.add(c1);
        
        c2.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/UpdateDetails.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/UpdateDetailsTeacher.png"));
        ...
        JMenuItem s3 = new JMenuItem("Fee Details");
        fee.setForeground(Color.BLUE);
        
        s1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon8.png"));
        ...
        ImageIcon icon19 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/FeeDetails.png"));
        Image image18 = icon19.getImage().getScaledInstance(30, 30,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon11.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/AboutUs.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("college/data/management/icons/icon12.png"));
