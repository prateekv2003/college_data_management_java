...
class UpdateStudent implements ActionListener{
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        lab1=new JLabel("Semester");
        lab1.setBounds(400,470,200,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"',course='"+c1.getSelectedItem()+"',branch='"+c2.getSelectedItem()+"',semester='"+c3.getSelectedItem()+"' where rollno='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                ...
                if(rs.next()){
                    ...
                    c1.setSelectedItem(rs.getString(12));
                    c2.setSelectedItem(rs.getString(13));
                    c3.setSelectedItem(rs.getString(14));
                }
